...
var minamike = function minamike(codeFunc) {
    ...
    minamike.prototype.compile = function () {
        ...
        expose({ __$__: __$__, $__: $__, __debugLog__: __debugLog__, __debugLog__: __debugLog__ }, true);
            ...
            case 'BinaryExpression':
                if (node.left.type !== 'Literal') {
                    ...
                    replaceCode(node, '__$__(' + left + ','
                     + between.replace(new RegExp('\\' + operator), '"' + operator + '"') + ', ' + right + ')');
                }
                break;
